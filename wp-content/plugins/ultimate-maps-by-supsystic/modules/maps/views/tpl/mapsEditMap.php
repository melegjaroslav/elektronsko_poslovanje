				...
				<td colspan="2" style="padding: 0;">
					<table class="form-table">
						<tr>
							...
							<td>
								<?php echo htmlUms::checkboxHiddenVal('map_opts[draggable]', array(
...
<?php */ ?>
			...
			<tr>
				<th scope="row">
					...
					<i style="float: right;" class="fa fa-question supsystic-tooltip" title="<?php _e('Hide the Points Of Interest - landmark or other object, the marked points on the map, for example: hotels, campsites, fuel stations etc.', UMS_LANG_CODE)?>"></i>
					<?php if(!$this->isPro) { ?>
